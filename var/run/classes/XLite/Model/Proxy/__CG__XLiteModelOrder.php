...
class Order extends \XLite\Model\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'usedCoupons', 'uspsShipment', 'capostParcels', 'capostReturns', 'capostOffice', 'mailchimpStoreId', 'not_finished_order', 'demo', 'reviewKey', 'conversation', 'xpaymentsFraudStatus', 'xpaymentsFraudType', 'xpaymentsFraudCheckTransactionId', 'buyWithApplePay', 'delayedPaymentSavedCardId', 'xpaymentsFraudCheckData', 'xpaymentsCards', 'order_id', 'profile', 'orig_profile', 'shipping_id', 'shipping_method_name', 'payment_method_name', 'tracking', 'date', 'lastRenewDate', 'paymentStatus', 'shippingStatus', 'notes', 'adminNotes', 'details', 'trackingNumbers', 'events', 'items', 'surcharges', 'payment_transactions', 'currency', 'orderNumber', 'recent', 'stockStatus', 'addItemError', 'oldPaymentStatus', 'isRemoving', 'oldShippingStatus', 'modifiers', 'shippingProcessor', 'isNotificationSent', 'ignoreCustomerNotifications', 'isNotificationsAllowedFlag', 'statusIsSet', 'paymentTransactionSums', 'sourceAddress', 'xcPendingExport', 'backorderCompetitors', 'backorderProductAmounts', 'temporary', 'justClosed', 'total', 'subtotal', '_previous_state'];
        }
    ...
    public function getDelayedPaymentSavedCardId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDelayedPaymentSavedCardId', []);

        return parent::getDelayedPaymentSavedCardId();
    }
    ...
    public function setDelayedPaymentSavedCardId($delayedPaymentSavedCardId = '')
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDelayedPaymentSavedCardId', [$delayedPaymentSavedCardId]);

        return parent::setDelayedPaymentSavedCardId($delayedPaymentSavedCardId);
    }
