 ...
 * Payment processor
 */
abstract class Processor extends \XLite\Model\Payment\Base\ProcessorAbstract implements \XLite\Base\IDecorator
{
    /**
    ...
    public function isApplicable(\XLite\Model\Order $order, \XLite\Model\Payment\Method $method)
    {
        ...
        if (
            ...
            && (
                ...
                || XPaymentsCloud::isDelayedPaymentEnabled()
            )
        ) {
            ...
            } elseif (!XPaymentsCloud::isDelayedPaymentEnabled()) {
